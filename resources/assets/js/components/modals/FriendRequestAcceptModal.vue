<template>
    <modal title="Accept Friend Request" :isVisible="isVisible" @close="hide">
        <template slot="body">
            ...
            <footer class="modal-card-foot">
                <a class="button is-success" :class="{'is-loading': isLoading}" @click="accept()">Accept Friend
                    Request</a>
    ...
    export default {
        ...
        methods: {
            accept() {
                let self = this;
                this.isLoading = true;
                this.$store.dispatch('friends/acceptRequest', this.request_id)
                    .then((response) => {
