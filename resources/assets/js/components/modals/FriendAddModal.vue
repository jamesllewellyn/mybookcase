<template>
    <div>
        ...
        <footer class="modal-card-foot">
            <a class="button is-success" :class="{'is-loading': modal.isLoading}"  @click="sendFriendRequest()">Send Friend Request</a>
    ...
    export default {
        ...
        methods: {
            sendFriendRequest () {
                ...
                store.dispatch('friendAdd', this.modal.data.id);
            },
            hide(){
                this.modal.hide();
            },
